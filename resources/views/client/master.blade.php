...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="https://nepalyanbooks.com/settting/1628147830Untitled-1.png">
...
<body class="skin-default fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Nepalyan</p>
        </div>
    </div>
    <!-- ============================================================== -->
    ...
    <div id="main-wrapper">
      ...
      @include('client.includes.header')
        ...
        <!-- ============================================================== -->
    @include('client.includes.leftsidebar')
