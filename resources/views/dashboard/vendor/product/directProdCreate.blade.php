    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <a href="{{ route('productBy.user') }}"><button type="button" class="btn btn-info d-none d-lg-block m-l-15">Your Product</button></a>
            </div>
        </div>
    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name = "name" class="form-control form-control-line"  value="" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name ="price" class="form-control form-control-line"  value="" required>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name ="author" class="form-control form-control-line"  value="" required>
                                </div>
                            </div>
                        </div>
                    </div>
