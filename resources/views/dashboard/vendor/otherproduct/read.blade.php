         ...
         <div class="fb5" id="fb5">
            ...
            <div id="fb5-container-book">
               ...
               <section id="fb5-deeplinking">
                ...
                @forelse ($product->other_topic as $index => $topic)
...
<!--    <link rel="icon" type="image/png" sizes="16x16" href="http://nepalyanbooks.com/settting/1628147830Untitled-1.png">    <title>Welcome || Dashboard</title>-->
   
<!--    <link href="{{ asset('read_style/bookblock.css')}}" }} rel="stylesheet">-->
<!--    <link href="{{ asset('read_style/custom.css')}}" }} rel="stylesheet">-->
<!--    <link href="{{ asset('read_style/jquery.jscrollpane.custom.css')}}" }} rel="stylesheet">-->
<!--        <script src="{{ asset('read_style/modernizr.custom.79639.js')}}"></script>-->
...
<!--				    @forelse ($product->other_topic as $index => $topic)-->
<!--				        @if($index == 0)-->
<!--				        	<li class="menu-toc-current"><a href="#{{$topic->id}}"><span>{{++$index}} </span>{{$topic->heading}}</a></li>-->

<!--				        @else-->
<!--				        	<li><a href="#{{$topic->id}}"><span>{{++$index}} </span> {{$topic->heading}}</a></li>-->
...
<!--    <script src="{{ asset('read_style/jquery.bookblock.js')}}"></script>-->
<!--    <script src="{{ asset('read_style/jquery.jscrollpane.min.js')}}"></script>-->
<!--    <script src="{{ asset('read_style/jquery.mousewheel.js')}}"></script>-->
<!--    <script src="{{ asset('read_style/jquerypp.custom.js')}}"></script>-->

<!--    <script src="{{ asset('read_style/page.js')}}"></script>-->
...
<!--{{----->
<!--@extends('dashboard.readmaster')-->
<!--@section('content')-->

<!--@include('dashboard.includes.leftsidebar-other')-->

<!--<div class="page-wrapper">-->
<!--    <div class="container-fluid">-->
<!--        @forelse ($product->other_topic as $topic)-->
<!--            <div id="div{{ $topic->id }}topic" class="targetDiv">{!! $topic->description !!}</div>-->

<!--            @forelse ($topic->otherTopicContent as $index => $tc)-->
<!--                <div class="row targetDiv" id="div{{ $tc->id }}topiccontent">-->
<!--                    <div class="user-box-inner">-->
<!--                        <div class="user-text-detail">-->
<!--                            <h3>{{ ucfirst($tc->title) }}</h3>-->
<!--                            <p>{!! $tc->content !!}</p>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
