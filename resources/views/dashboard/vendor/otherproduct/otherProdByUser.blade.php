...
<div class="container-fluid">
   <div class="row page-titles">
      <div class="col-md-5 align-self-center">
         <h4 class="text-themecolor">My Other Products </h4>
      </div>
      <div class="col-md-7 align-self-center text-right">
         <div class="d-flex justify-content-end align-items-center">
            ...
            <a href="{{ route('directOtherProd.create') }}"> <button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="text-success">
                            <span class="badge badge-success m-r-5 m-b-5">Featured</span>

                           </td>
                           @else
                           <td class="text-danger">
                            <span class="badge badge-danger m-r-5 m-b-5">Not Featured</span>
                           ...
                           @endif
                            ...
                            <!--@if ($item->approve == 0)-->
                                <td>
                                    <div class="action" style="display: flex">
                                        <a href="" data-toggle="modal" data-target="#{{ $item->id }}modal" class="btn btn-rounded btn-xs btn-info m-r-5" data-toggle="tooltip" data-placement="top" title="Edit Product">
                                        ...
                                        <div class="modal fade" id="{{ $item->id }}modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            ...
                                            <div class="modal-content rose">
                                                ...
                                                <div class="modal-body">
                                                    <form class="m-t-40" method="post" action="{{ route('otherProductBy.user.update',$item->id ) }}" enctype="multipart/form-data">
                                        ...
                                        <a href="{{ route('add.other.topic',$item->slug) }}" class="btn btn-rounded btn-xs btn-info m-r-5" target="blank" data-toggle="tooltip" data-original-title="Add Content">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                        
                                        <a href="{{ route('read.otherproduct',$item->slug) }}" class="btn btn-rounded btn-xs btn-info m-r-5" target="_blank" data-toggle="tooltip" data-original-title="Add Content">
                                            Read
                                        </a>

                                        <a href="" class="btn btn-rounded btn-xs btn-danger m-r-5" data-toggle="tooltip" data-original-title="Delete"
                            ...
                            <!--@else-->
                                <!--<td>-->
                                    <!--<a href="{{ route('read.otherproduct',$item->slug) }}" class="btn btn-rounded btn-xs btn-info m-r-5" target="blank" data-toggle="tooltip" data-original-title="Add Content">-->
                                    <!--    Read-->
                                    <!--</a>-->
                                <!--</td>-->
                            <!--@endif-->
