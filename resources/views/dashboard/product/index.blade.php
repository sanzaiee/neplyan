   ...
   <div class="row page-titles">
      ...
      <div class="col-md-7 align-self-center text-right">
         <div class="d-flex justify-content-end align-items-center">
            ...
            <a href="{{ route('add.product',$semester) }}"> <button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="action" style="display: flex">
                                 ...
                                 <a href="{{route('add.topic',$item->slug)}}" class="btn btn-rounded btn-xs btn-info m-r-5" data-toggle="tooltip"
                                    data-original-title="Add Content">
                                 <i class="fa fa-plus"></i>
                                 </a>
                                 
                                  <a href="{{route('read.content',$item->slug)}}" target="_blank" class="btn btn-rounded btn-xs btn-info m-r-5" data-toggle="tooltip"
                                    data-original-title="Read Content">
                                 <i class="fa fa-eye"></i>
                                 </a>
