    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Send Message</h4>
            </div>
        ...
        <div class="row list-of-items">
            ...
            <div class="col-8">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Private Message to Users</h4>
                        <h6 class="card-subtitle">Please <code>Fill Up</code> all the fields.</h6>

                        <form method="post" action="{{ route('private.store') }}" enctype="multipart/form-data">
                        @csrf
