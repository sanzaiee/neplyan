      ...
      <div class="col-12">
         <div class="card">
            <div class="card-body">
               ...
               <form method="post" action="{{ route('othertopiccontent.store') }}" enctype="multipart/form-data">
                  @csrf
                  <input type="hidden" name="other_topic_id" id="" value="{{ $topic->id }}">
                  <div class="card">
                     <div class="card-body">
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="action" style="display: flex">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                       <div class="modal-content rose">
                                          ...
                                          <div class="modal-body">
                                             <form class="m-t-40" method="post" action="{{ route('othertopiccontent.update',$item->id ) }}" enctype="multipart/form-data">
                                                <input type="hidden" name="_method" value="PUT">
                                                @csrf
                                                <input type="hidden" name="other_topic_id" value="{{ $topic->id }}">
                                                <div class="card">
                                                   <div class="card-body">
                                                      <div class="form-group">
                                                         <h4 class="card-title">Title</h4>
                                 ...
                                 <form id="delete-form-{{ $item->id }}" action="{{route('othertopiccontent.destroy',$item->id)}}" method="post">
                                    @csrf
                                    @method('delete')
                                 </form>
