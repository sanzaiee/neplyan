...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Levels<h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('user.dashboard',Auth::user()->name) }}">Home</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('education.create', $materials->education->name) }} ">{{ $materials->education->name }}</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('add.material',$materials->education->slug) }} ">{{ $materials->name }}</a></li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @csrf --}}
                    @csrf
                    <input type="hidden" name="material_id" id="" value="{{ $material }}">
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                                                   <div class="modal-content rose">
                                                                      ...
                                                                      <div class="modal-body">
                                                                        ...
                                                                        <form class="m-t-40" method="post" action="{{ route('level.update',$item->id ) }}" enctype="multipart/form-data">
                                                                            <input type="hidden" name="_method" value="PUT">
                                                                            @csrf
                                                                            ...
                                                                            <div class="card">
                                                                                <div class="card-body">
                                                                                    <div class="form-group">
                                                                                        <h4 class="card-title">Level Position</h4>
                                                                                        <input type="number" name = "position" class="form-control form-control-line" value="{{ $item->position }}" required>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="card">
                                                                                <div class="card-body">
                                                                                    <div class="form-group">
                                                                                        <h4 class="card-title">Level Slug</h4>
    ...
    {{-- for editing contents ends here modal --}}
                                                        ...
                                                        <form id="delete-form-{{ $item->id }}" action="{{route('level.destroy',$item->id)}}" method="post">
                                                        @csrf
                                                        @method('delete')
                                                        </form>
                                                        ...
                                                        <a href="{{ route('add.semester',$item->slug) }}" class="btn btn-rounded btn-sm btn-primary m-r-5" data-toggle="tooltip" data-original-title="Add Content">
                                                            <i class="fa fa-plus">Add Semester</i>
                                                        </a>
                                                </div>
