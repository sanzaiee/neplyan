...
<div class="row page-titles">
    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            ...
            <a href="{{ route('notice.create') }}"> <button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i
                                       ...
                                       <tr>
                                        <td>{{ ++$index }}</td>
                                           ...
                                           @if ($item->contentType == 1)
                                                <td>
                                                    <img src="{{ asset($item->content) }}" width="100px" height="100px">
                                                </td>
                                           @else
                                             <td>
                                                <a>
                                                    <a href="{{ $item->content }}"><img src="{{ asset('dummyPdf.png') }}" width="100px" height="100px"></a>
                                                    {{-- <iframe src="{{ $item->content }}" height="200" width="300"></iframe> --}}
                                                </td>
                                            @endif
                                           ...
                                           <td>
                                                <a href="{{ route('notice.edit',$item->id) }}" class="btn btn-rounded btn-xs btn-info m-r-5" data-toggle="tooltip" data-original-title="Edit">
                                                ...
                                                <form id="delete-form-{{ $item->id }}" action="{{route('notice.destroy',$item->id)}}" method="post">
                                                @csrf
                                                @method('delete')
                                                </form>
                                            </td>
