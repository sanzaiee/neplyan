                                   ...
                                   @forelse ($tags as $index=>$item)
                                       <tr>
                                        <td>{{ ++$index }}</td>
                                           ...
                                           <td>
                                                <a href="{{ route('tag.edit',$item->id) }}" class="btn btn-rounded btn-xs btn-info m-r-5" data-toggle="tooltip" data-original-title="Edit">
                                                ...
                                                <form id="delete-form-{{ $item->id }}" action="{{route('tag.destroy',$item->id)}}" method="post">
                                                @csrf
                                                @method('delete')
                                                </form>
