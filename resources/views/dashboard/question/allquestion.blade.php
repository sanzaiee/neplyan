    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <a href="{{ route('direct.add.question') }}"><button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i
                    class="fa fa-plus-circle"></i>Question</button></a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
            ...
            <div class="col-md-12 mb-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form action="{{ route('allQuestion.byProduct') }}" method="POST">
                                    @csrf
                                    <div class="row align-items-center">
                                        ...
                                        {{--  <div class="col-md">
                                            <div class="form-group mr-1">
                                                <p class="text-muted text-primary text-center">Question</p>
                                                <select class="form-control form-control-line" name="question_id" id="question">
                                                </select>
                                            </div>
                                        </div>  --}}
                                        ...
                                        {{-- <div class="col-md">
                                            <div class="form-group mr-1">
                                                <p class="text-muted text-primary text-center">Topics</p>
                                                <select class="form-control form-control-line" name="topic_id" id="topic">
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md">
                                            <div class="form-group mr-1">
                                                <p class="text-muted text-primary text-center">Topic Content</p>
                                                <select class="form-control form-control-line" name="content_id" id="topiccontent">
                                                </select>
                                            </div>
                                        </div> --}}
                                    </div>
...
<script>
    ...
    // console.log(id);
    // $('#question').empty();
    // $('#question').append(`<option value="0" disabled selected>Processing....</option`)
    //     $.ajax({
    //         type:'GET',
    //         url:'/dropdownlist/question/'+id,
    //         success:function(response){
    //             var response = JSON.parse(response);
    //             console.log(response);
    //             $('#question').empty();
