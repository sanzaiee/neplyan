...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Testimonals</h4>
    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            ...
            <a href="{{ route('testimonal.create') }}"> <button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i
...
<div class="row list-of-items">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Testimonal List</h4>
                ...
                <div class="table-responsive m-t-40">
                        <table id="myTable" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                   @forelse ($testimonals as $index=>$item)
                                       <tr>
                                        <td>{{ ++$index }}</td>
                                           ...
                                           <td>
                                                <a href="{{ route('testimonal.edit',$item->id) }}" class="btn btn-rounded btn-xs btn-info m-r-5" data-toggle="tooltip" data-original-title="Edit">
                                                ...
                                                <form id="delete-form-{{ $item->id }}" action="{{route('testimonal.destroy',$item->id)}}" method="post">
                                                @csrf
                                                @method('delete')
                                                </form>
                                            </td>
