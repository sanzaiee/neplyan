    ...
    <div class="row  page-titles">
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <a href="{{ route('about.index') }}"><button type="button" class="btn btn-info d-none d-lg-block m-l-15">
    ...
    <div class="list-of-items">
            <div class="card">
                <div class="card-body">
                    ...
                    @if ($about)
                        <form class="m-t-40" method="post" action="{{ route('about.update',$about->id ) }}" enctype="multipart/form-data">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name = "title" class="form-control form-control-line"  value="{{ $about->title ?? '' }}" required>
                                    </div>
                                </div>
                            </div>
